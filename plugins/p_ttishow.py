...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Nayagan_Update_bot4")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           ...
                                                                           InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Nayagan_Update_bot")
                                                                         ]]
                                                 ),
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://t.me/+3kl-Cp4vE5M2MjM1"),
            InlineKeyboardButton('Owner', url="http://t.me/Nayagan_Update_bot")
        ],[
